...
arch = {"vgg19":25088, "densenet121":1024}
...
def network_construct(structure='vgg19',dropout=0.5, hidden_layer1 = 4096,lr = 0.001,device='gpu'):
    if structure == 'vgg16':
        model = models.vgg16(pretrained=True)
    elif structure == 'densenet121':
        model = models.densenet121(pretrained=True)
    else:
        print("Please try for vgg19 or densenet121 only")
...
def save_checkpoint(model=0,path='checkpoint.pth',structure ='vgg19', hidden_layer1 = 4096,dropout=0.5,lr=0.001,epochs=3):
